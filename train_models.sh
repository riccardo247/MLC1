...
cd /MLC1/
# Run Python scripts 
python train_decoder.py --nepochs 50 --nlayers_decoder 1 --batch_size 25 --episode_type algebraic --fn_out_model net-LLAMA_50ep_1layer_alg.pt
python train_decoder.py --nepochs 50 --nlayers_decoder 2 --batch_size 25 --episode_type algebraic --fn_out_model net-LLAMA_50ep_2layer_alg.pt
python train_decoder.py --nepochs 50 --nlayers_decoder 3 --batch_size 25 --episode_type algebraic --fn_out_model net-LLAMA_50ep_3layer_alg.pt
python train_decoder.py --nepochs 50 --nlayers_decoder 4 --batch_size 25 --episode_type algebraic --fn_out_model net-LLAMA_50ep_4layer_alg.pt
python train_decoder.py --nepochs 50 --nlayers_decoder 4 --batch_size 25 --episode_type algebraic --fn_out_model net-LLAMA_50ep_5layer_alg.pt
